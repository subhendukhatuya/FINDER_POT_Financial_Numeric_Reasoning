...
if __name__ == "__main__":
    with open('Data_Target_Module/flan_retriever/output/best_matched_with_retrieved_facts_and_questions_flan_promptpg.json') as f:
    ...
    if args.greedy:
        filename = f'Experiment/Final/finqa_greedy_flan_promptpg_default.jsonl'
    else:
